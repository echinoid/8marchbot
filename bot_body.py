...
def step3(call):
    ...
    send_message(call.from_user.id, st3_message_1, st3_image_1, markup, 2)
...
def step4(call):
    ...
    send_message(call.from_user.id, st4_message_2, timer=2)
...
def step6(call):
    ...
    send_message(call.from_user.id, st6_message_1, markup=markup, timer=2)
...
def step7(call):
    ...
    send_message(call.from_user.id, st7_message_1, markup=markup, timer=2)
...
def step8(call):
    ...
    st8_message_1 = ''
    if call.data == 'to_8_1':
        st8_image_1 = 'https://i.postimg.cc/Y088vYjS/strazh-da.png'
        st8_message_1 = 'Хм, похоже ты говоришь правду. Она называет свое имя только друзьям. Хорошо, я соединяю вас.'
    ...
    send_message(call.from_user.id, st8_message_1, st8_image_1, markup, 2)
...
def to_exit(call):
    ...
    if call.data == 'to_exit_end':
        ...
        exit_button_1 = types.InlineKeyboardButton(text='Повторить заново', callback_data='restart')
        markup.add(exit_button_1)

    send_message(call.from_user.id, exit_message_1, exit_image_1, markup, 2)
...
def to_exit2(call):
    ...
    exit2_button_1 = types.InlineKeyboardButton(text='Повторить заново', callback_data='restart')
